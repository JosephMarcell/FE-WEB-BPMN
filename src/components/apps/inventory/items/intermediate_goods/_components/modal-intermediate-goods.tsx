...
interface IModalIntermediateGoodsProps {
  modal: boolean;
  modalEdit: boolean;
...
const ModalIntermediateGoods = ({
  modal,
  modalEdit,
  setModal,
  setModalEdit,
  refetch,
}: IModalIntermediateGoodsProps) => {
...
export default ModalIntermediateGoods;
