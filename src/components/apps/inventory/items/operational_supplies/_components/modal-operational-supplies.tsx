...
interface IModalOperationalSuppliesProps {
  modal: boolean;
  modalEdit: boolean;
...
const ModalOperationalSupplies = ({
  modal,
  modalEdit,
  setModal,
  setModalEdit,
  refetch,
}: IModalOperationalSuppliesProps) => {
...
export default ModalOperationalSupplies;
