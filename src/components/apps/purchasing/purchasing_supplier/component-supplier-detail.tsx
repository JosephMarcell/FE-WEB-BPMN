...
import SupplierDetailComponent from './_components/detail-page';

interface IPurchaseRequestDetail {
  pkid: number;
}
const ComponentSupplierDetail = ({ pkid }: IPurchaseRequestDetail) => {
    ...
    <div className='space-y-5'>
      ...
      <div className='relative flex h-full flex-col gap-5'>
        {isLoading ? (
          ...
          <SupplierDetailComponent data={supplierDetail} />
        )}
      </div>
    </div>
  );
...
export default ComponentSupplierDetail;
