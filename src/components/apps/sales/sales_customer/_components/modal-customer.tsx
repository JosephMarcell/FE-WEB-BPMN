...
import { useCreateCustomer } from '@/app/api/hooks/sales/customer/useCreateCustomer';
import { useGetCustomerByPkid } from '@/app/api/hooks/sales/customer/useGetCustomerByPkid';
import { useUpdateCustomer } from '@/app/api/hooks/sales/customer/useUpdateCustomer';
import { paymentTerms } from '@/helpers/utils/purchasing/supplier';
import {
...
const ModalNewCustomer = ({
  ...
  const [form, setForm] = useState(customerInitialState);
  ...
  } = useGetCustomerByPkid(pkid, enabled);
  ...
  useEffect(() => {
    if (customerDetail && modalEdit) {
      setForm(customerDetail);
    }
  }, [customerDetail, modalEdit]);
  ...
  const handleCancel = () => {
    if (JSON.stringify(form) === JSON.stringify(customerInitialState)) {
      if (modalEdit) {
        setModalEdit(false);
      }
      if (modal) {
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          styles={{
                            control: provided => ({
                              ...provided,
                              borderColor: emptyField.includes('customer_type')
                                ? 'red'
                                : '',
                              zIndex: 9999,
                            }),
                    ...
                    <div className='grid grid-cols-1 gap-4 sm:grid-cols-3'>
                      <div>
                        ...
                        <input
                          ...
                          className='form-input'
                          onChange={e =>
                            handleOnChange(String(e.target.value), 'industry')
                          }
                          value={form.industry || ''}
                          style={{
                            borderColor: emptyField.includes('industry')
                              ? 'red'
                              : '',
                          }}
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          style={{
                            borderColor: emptyField.includes('account_manager')
                              ? 'red'
                              : '',
                          }}
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className='form-input'
                          onChange={e =>
                            handleOnChange(String(e.target.value), 'company')
                          }
                          value={form.company || ''}
                          style={{
                            borderColor: emptyField.includes('company')
                              ? 'red'
                              : '',
                          }}
                        />
