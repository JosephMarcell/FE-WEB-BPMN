...
import BlueCollarSalarySlipTable from '@/components/apps/hrm/payroll/blue_collar_salary_slip/_components/blue-collar-salary-slip-table'; // Ensure the correct import

import { useGetAllEmployeeSalarySlipsBlue } from '@/app/api/hooks/hrm/salary_slip/useGetAllSalarySlip';
...
const ComponentBlueCollarSalarySlip = () => {
  ...
  const { data: combinedData, isLoading } = useGetAllEmployeeSalarySlipsBlue();
...
export default ComponentBlueCollarSalarySlip;
